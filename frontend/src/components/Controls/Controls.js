    ...
    <div className="controls">
      ...
      <div className="control-group">
        ...
        <Select
          ...
          isDisabled={loading}
          theme={(theme) => ({ ...theme, colors: { ...theme.colors, primary: '#e67e22', primary75: '#f39c12', primary50: '#f5b041', primary25: '#fdebd0' } } })}
        />
      </div>
      ...
      <div className="control-group">
        ...
        <div className="filter-group">
          ...
          <label className="filter-label"><input type="checkbox" checked={showSdis} onChange={(e) => setShowSdis(e.target.checked)} disabled={loading} /> SDIS</label>
      ...
      <div className="control-group">
        ...
        <Select
          ...
          classNamePrefix="react-select"
          isDisabled={loading}
          theme={(theme) => ({ ...theme, colors: { ...theme.colors, primary: '#2e86de', primary75: '#54a0ff', primary50: '#7fbfff', primary25: '#d6eaf8' } } })}
        />
        {wmsLayer && (
          <div className="control-row" style={{ marginTop: '4px' }}>
            <label className="control-label-small">Opacité</label>
            <input type="range" min="0" max="1" step="0.05" value={wmsOpacity} onChange={(e) => setWmsOpacity(parseFloat(e.target.value))} style={{ flex: 1 }} />
            <span style={{ fontSize: '0.7rem', minWidth: '30px' }}>{Math.round(wmsOpacity * 100)}%</span>
          </div>
        )}
